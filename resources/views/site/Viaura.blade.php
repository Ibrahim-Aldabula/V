    ...
    <nav class="navbar navbar-expand-lg" data-aos="fade-down" data-aos-delay="100">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav">
            <li class="nav-item" data-aos="fade-left" data-aos-delay="200"> <a href="Login-Signup.html" class="btn btn-outline-success">
                LOGIN
              </a>
            </li>
            <li class="nav-item" data-aos="fade-left" data-aos-delay="400">
              <a href="Login-Signup.html" class="btn btn-success me-3">
                SIGNUP
              </a>
            </li>
          </ul>
        ...
        <div class="container mx-auto">
          ...
          <div class="row align-items-center mb-5">
            <div class="col-lg-6" data-aos="fade-right" data-aos-delay="300" data-aos-duration="500">
              ...
              <a href="education.html" class="btn btn-success mb-sm-4">Explore More <i
        ...
        <div class="row explore-more align-items-center justify-content-evenly my-5">
          ...
          <div class="col-lg-5">
            <h3 class="mb-40 mt-sm-5" data-aos="fade-left" data-aos-delay="100">Lorem ipsum dolor sit, amet consectetur
              adipisicing elit.</h3>
            <a href="education.html" class="btn btn-outline-success" data-aos="fade-up" data-aos-delay="200">Explore
